...
return [
  ...
  'membershipextras_paymentplan_update_start_date_renewal' => [
    ...
    'membershipextras_paymentplan_use_itemmanager_as_period_source' => [
        'group_name' => 'MembershipExtras: Payment Plan',
        'group' => 'membershipextras_paymentplan',
        'name' => 'membershipextras_paymentplan_use_itemmanager_as_period_source',
        'title' => 'Use Itemmanager for Payment Plan Automation ?',
        'type' => 'Integer',
        'html_type' => 'checkbox',
        'quick_form_type' => 'Element',
        'default' => FALSE,
    ...
    'membershipextras_paymentplan_disable_automatic_response_mail' => [
        'group_name' => 'MembershipExtras: Payment Plan',
        'group' => 'membershipextras_paymentplan',
        'name' => 'membershipextras_paymentplan_disable_automatic_response_mail',
        'title' => 'Disable response mails for paid status ?',
        'type' => 'Integer',
        'html_type' => 'checkbox',
        'quick_form_type' => 'Element',
        'default' => TRUE,
    ...
    'membershipextras_paymentplan_disable_autorenew' => [
        'group_name' => 'MembershipExtras: Payment Plan',
        'group' => 'membershipextras_paymentplan',
        'name' => 'membershipextras_paymentplan_disable_autorenew',
    ...
    'membershipextras_paymentplan_enable_fixed_startdate' => [
        'group_name' => 'MembershipExtras: Payment Plan',
        'group' => 'membershipextras_paymentplan',
        'name' => 'membershipextras_paymentplan_enable_fixed_startdate',
        'title' => 'Fix start date of membership ?',
        'type' => 'Integer',
        'html_type' => 'checkbox',
        'quick_form_type' => 'Element',
        'default' => FALSE,
    ...
    'membershipextras_paymentplan_fixed_day' => [
        'name' => 'membershipextras_paymentplan_fixed_day',
        'group_name' => 'MembershipExtras: Payment Plan',
        'group' => 'membershipextras_paymentplan',
        'type' => 'Integer',
        'quick_form_type' => 'Element',
        ...
        'html_type' => 'text',
        'is_required' => FALSE,
        'description' => 'Fixed startdate where the payment contributions should start.',
        'help_text' => 'Please enable first.',
    ],
];
